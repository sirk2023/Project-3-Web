...
var rootURL = "http://localhost/Website102111/api/requestedJobs";
var userURL = "http://localhost/Website102111/api/users";
var customerURL = "http://localhost/Website102111/api/customers";
var acceptedJobURL = "http://localhost/Website102111/api/acceptedJobs";
var signatureURL = "http://localhost/Website102111/api/signatures";
var batchURL = "http://localhost/Website102111/api/batches";
var collectedHardDriveURL = "http://localhost/Website102111/api/collectedHardDrives";
var videoFileURL = "http://localhost/Website102111/api/videoFiles";
var completedJobURL = "http://localhost/Website102111/api/completedJobs";
...
$(document).ready(function () {
	...
	$(document).on("click", '#edtAcceptedJobForm', function () { updateAcceptedJobModalTable(); });
	$(document).on("click", '#edtAcceptedJobForm', function () { updateSignatureModalTable(); });
	$(document).on("click", '#edtBatchForm', function () { updateBatchModalTable(); });
	$(document).on("click", '#edtCollectedHardDriveForm', function () { updateCollectedHardDriveModalTable(); });
	$(document).on("click", '#edtVideoFileForm', function () { updateVideoFileModalTable(); });
	$(document).on("click", '#edtCompletedJobForm', function () { updateCompletedJobModalTable(); });
	//Edit Save Button
	$(document).on("click", '#saveRequestedJob', function () { updateRequestedJob(); });
	$(document).on("click", '#saveCustomer', function () { updateCustomer(); });
	$(document).on("click", '#saveAcceptedJob', function () { updateAcceptedJob(); });
	$(document).on("click", '#saveSignature', function () { updateSignature(); });
	$(document).on("click", '#saveBatch', function () { updateBatch(); });
	$(document).on("click", '#saveCollectedHardDrive', function () { updateCollectedHardDrive(); });
	$(document).on("click", '#saveVideoFile', function () { updateVideoFile(); });
	$(document).on("click", '#saveCompletedJob', function () { updateCompletedJob(); });
			...
			success:function(data)
			{
				...
				if(data.row_data){
					for(var count =0; count < data.row_data.length; count++){
						html += '<tr>';
						html += '<td class="hdd_serial_number" contenteditable>+data.row_data[count].hdd_serial_number+</td>';
						html += '<td class="batch_id" contenteditable>+data.row_data[count].batch_id+</td>';
					}
				}
				html += '<table>';
...
var renderAcceptedJobDetails = function (acceptedJob) {
	...
	var htmlButtons = '<button type="button" class="btn btn-default" data-dismiss="modal"' +
		...
		'id="edtAcceptedJobForm">Edit Accepted Job</button>';
	$("#modalFooter").html(htmlButtons);
};
...
//Calls the PUT method of your rest API. 
var updateAcceptedJob = function () {
	console.log('updateAcceptedJob');
	$.ajax({
		type: 'PUT',
		contentType: 'application/json',
		url: acceptedJobURL + '/' + $('#customer_id').val(),
		dataType: "json",
		data: acceptedJobToJSON(),
		success: function (customerData, textStatus, jqXHR) {
			alert('Accepted Job updated successfully');
			findAll();
		},
		error: function (jqXHR, textStatus, errorThrown) {
			alert('update Accepted Job error: ' + textStatus);
		}
	});
};
...
var updateAcceptedJobModalTable = function () {
	// Get the customer IDs from the session
	//var customerId = sessionStorage.getItem('customer_id');

	var htmlStr = '<div class="modal-header">' +
		'<h2 class="modal-title">Edit Accepted Job</h2>' +
		'<button type="button" class="close" data-dismiss="modal">&times;</button>' +
		'</div>' +
		'<div class="modal-body">' +
		'<form>' +
	...
	var htmlButtons = '<div class="modal-footer">' +
		'<button type="button" class="btn btn-primary" id="saveAcceptedJob">Save Accepted Job</button>' +
		'<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>' +
		'</div>';
...
var renderSignaturesDetails = function (signature) {
	...
	var htmlButtons = '<button type="button" class="btn btn-default" data-dismiss="modal"' +
		...
		'id="edtAcceptedJobForm">Edit Signature</button>';
	$("#modalFooter").html(htmlButtons);
};
...
var updateSignature = function () {
	...
	$.ajax({
		type: 'PUT',
		contentType: 'application/json',
		url: signatureURL + '/' + $('#signature_id').val(),
		dataType: "json",
		data: signatureToJSON(),
		success: function (customerData, textStatus, jqXHR) {
		...
		error: function (jqXHR, textStatus, errorThrown) {
			alert('update Signature error: ' + textStatus);
		}
	});
};
...
var updateSignatureModalTable = function () {
	// Get the customer IDs from the session
	//var customerId = sessionStorage.getItem('customer_id');
...
var renderBatchDetails = function (batch) {
	...
	var htmlButtons = '<button type="button" class="btn btn-default" data-dismiss="modal"' +
		...
		'id="edtBatchForm">Edit Request</button>';
	$("#modalFooter").html(htmlButtons);
};
...
var updateBatch = function () {
	...
	$.ajax({
		...
		error: function (jqXHR, textStatus, errorThrown) {
			alert('update Batch error: ' + textStatus);
		}
	});
};
...
var updateBatchModalTable = function () {
	// Get the customer IDs from the session
	//var customerId = sessionStorage.getItem('customer_id');

	var htmlStr = '<div class="modal-header">' +
		'<h2 class="modal-title">Edit Batches</h2>' +
		'<button type="button" class="close" data-dismiss="modal">&times;</button>' +
		'</div>' +
		'<div class="modal-body">' +
		'<form>' +
...
var renderCollectedHardDrivesDetails = function (collectedHardDrive) {
	...
	$('#myModal').modal('show');
	var htmlButtons = '<button type="button" class="btn btn-default" data-dismiss="modal"' +
		'id="delCollectedHardDrive">Delete</button>' + '<button type="button" class="btn btn-default"' +
		'id="edtCollectedHardDriveForm">Edit</button>';
	$("#modalFooter").html(htmlButtons);
};
...
//Calls the PUT method of your rest API. 
var updateCollectedHardDrive = function () {
	console.log('updateCollectedHardDrive');
	$.ajax({
		type: 'PUT',
		contentType: 'application/json',
		url: collectedHardDriveURL + '/' + $('#collected_harddrives_id').val(),
		dataType: "json",
		data: collectedHardDriveToJSON(),
		success: function (customerData, textStatus, jqXHR) {
			alert('Collected Hard Drive updated successfully');
			findAll();
		},
		error: function (jqXHR, textStatus, errorThrown) {
			alert('update Collected Hard Drive error: ' + textStatus);
		}
	});
};
...
var updateCollectedHardDriveModalTable = function () {
	// Get the customer IDs from the session
	//var customerId = sessionStorage.getItem('customer_id');

	var htmlStr = '<div class="modal-header">' +
		'<h2 class="modal-title">Edit Collected Hard Drives</h2>' +
		'<button type="button" class="close" data-dismiss="modal">&times;</button>' +
		'</div>' +
		'<div class="modal-body">' +
		'<form>' +
	...
	var htmlButtons = '<div class="modal-footer">' +
		'<button type="button" class="btn btn-primary" id="saveCollectedHardDrive">Save Collection</button>' +
		'<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>' +
		'</div>';
...
var renderVideoFilesDetails = function (videoFile) {
	...
	var htmlButtons = '<button type="button" class="btn btn-default" data-dismiss="modal"' +
		...
		'id="edtVideoFileForm">Edit Request</button>';
	$("#modalFooter").html(htmlButtons);
};
...
//Calls the PUT method of your rest API. 
var updateVideoFile = function () {
	console.log('updateVideoFile');
	$.ajax({
		type: 'PUT',
		contentType: 'application/json',
		url: videoFileURL + '/' + $('#video_id').val(),
		dataType: "json",
		data: videoFileToJSON(),
		success: function (customerData, textStatus, jqXHR) {
			alert('Video Doc updated successfully');
			findAll();
		},
		error: function (jqXHR, textStatus, errorThrown) {
			alert('update Video Doc error: ' + textStatus);
		}
	});
};
...
var updateVideoFileModalTable = function () {
	// Get the customer IDs from the session
	//var customerId = sessionStorage.getItem('customer_id');

	var htmlStr = '<div class="modal-header">' +
		'<h2 class="modal-title">Edit Video Files</h2>' +
		'<button type="button" class="close" data-dismiss="modal">&times;</button>' +
		'</div>' +
		'<div class="modal-body">' +
		'<form>' +
	...
	var htmlButtons = '<div class="modal-footer">' +
		'<button type="button" class="btn btn-primary" id="saveVideoFile">Save Collection</button>' +
		'<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>' +
		'</div>';
...
var renderCompletedJobDetails = function (completedJob) {
	...
	var htmlButtons = '<button type="button" class="btn btn-default" data-dismiss="modal"' +
		...
		'id="edtCompletedJobForm">Edit Request</button>';
	$("#modalFooter").html(htmlButtons);
};
...
//Calls the PUT method of your rest API. 
var updateCompletedJob = function () {
	console.log('updateCompletedJob');
	$.ajax({
		type: 'PUT',
		contentType: 'application/json',
		url: completedJobURL + '/' + $('#job_id').val(),
		dataType: "json",
		data: completedJobToJSON(),
		success: function (requestJobData, textStatus, jqXHR) {
			alert('Completed Job updated successfully');
			findAll();
		},
		error: function (jqXHR, textStatus, errorThrown) {
			alert('update Completed Job error: ' + textStatus);
		}
	});
};
...
var updateCompletedJobModalTable = function () {
	// Get the customer IDs from the session
	//var customerId = sessionStorage.getItem('customer_id');

	var htmlStr = '<div class="modal-header">' +
		'<h2 class="modal-title">Edit Completed Jobs</h2>' +
		'<button type="button" class="close" data-dismiss="modal">&times;</button>' +
		'</div>' +
		'<div class="modal-body">' +
		'<form>' +
	...
	var htmlButtons = '<div class="modal-footer">' +
		'<button type="button" class="btn btn-primary" id="saveCompletedJob">Save Completed Job</button>' +
		'<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>' +
		'</div>';
