...
?>
        ...
        <section class="index-catagories">
            ...
            <div class="modal fade" id="myModal" role="dialog">
                ...
                <p>Here is a list of Signatures!</p>
                <div class="" id="products">
                    <table id="signature_table_id" class="display">
                        <thead>
                            <tr>
                                <th>Job Id</th>
                                <th>Customer Id</th>
                        ...
                        <tbody id="table_body_signature">
                    </tbody>
                </table>
            </div>
                <button class="btn btn-primary" id="addSModal">Add Signature</button>
                <p>This is Signature Page</p>
            </div>
        </section>
